...
out_path = os.path.join(base_dir, "all_acor_summary.png")

subdirs = sorted([
    d for d in os.listdir(base_dir)
    if os.path.isdir(os.path.join(base_dir, d)) and 
       os.path.exists(os.path.join(base_dir, d, "acor_gray.png"))
])
...
for i, name in enumerate(subdirs):
    img_path = os.path.join(base_dir, name, "acor_gray.png")
